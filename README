...
- gcc (gcc-4.6.2)
- >=cmake-2.6 (cmake-2.8.7)
- gmake/make (make-3.82)
- Qt4 (Qt-4.8.0)
- SQLite3 (sqlite-3.7.10)
...
Instalacja może wyglądać różnie w zależności czy korzystamy z MinGW czy z innego środowiska.
Do budowy środowiska można użyć skrytpu build_MinGW.bat
