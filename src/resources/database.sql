...
CREATE TABLE IF NOT EXISTS meal ( id INTEGER PRIMARY KEY AUTOINCREMENT, distdate VARCHAR(20), mealtype INTEGER, name VARCHAR(32), scouts INTEGER, leaders INTEGER, others INTEGER, avcosts FLOAT );
